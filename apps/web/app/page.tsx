...
import { Badge, ErrorMessage, Mark, Submit } from '@/components/common';
        ...
        <div className="guide-steps">
          {[
            ...
            [
              '03',
              'Bring your AI',
              'Create a client key with explicit connection access. Add the Mack endpoint and bearer token to your MCP client.',
            ],
            [
              '04',
